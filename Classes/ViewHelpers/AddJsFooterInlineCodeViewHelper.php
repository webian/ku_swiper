...
class AddJsFooterInlineCodeViewHelper extends AbstractTagBasedViewHelper
{
    ...
    {
        $this->registerArgument('name', 'string', 'Name argument', TRUE);
        $this->registerArgument('compress', 'boolean', 'Compress argument', FALSE, TRUE);
        $this->registerArgument('forceOnTop', 'boolean', 'ForceOnTop argument', FALSE, FALSE);
    }
